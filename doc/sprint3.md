...
支持为产品录入**非每日、不连续的估值金额**，作为后续一切分析的原始输入。
...
```json
{
  "source": "manual",
  "rows": [
    { "product_id": 200, "date": "2024-12-30", "market_value": 100000.00 },
    { "product_id": 200, "date": "2025-01-05", "market_value": 100059.46 }
  ]
}
```
...
#### GET /api/products/{id}/valuations?from=2024-12-01&to=2025-01-31
...
* `getValuationSeries(product_id, from, to, interpolate=true)`
...
[
\left(\frac{V_{end}}{V_{start}}\right)^{\frac{52}{周数}} - 1
]
...
#### GET /api/products/{id}/metrics?window=8w
